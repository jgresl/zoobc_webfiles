		...
		<div id="maincontent">
			...
			<%
				...
				try (Connection con = DriverManager.getConnection(url, uid, pw)) {
					...
					out.print("<image src = \"images/finalwarning.jpg\">");
					out.print("<br><br><br>Are you sure you want to restore the database to its initial state?");
					out.print("&nbsp;&nbsp;<input type=button OnClick=\"\" value=\"Yes, I know what I'm doing\">");
					}
				}
			%>
		</div>
